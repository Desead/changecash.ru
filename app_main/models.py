...
class Money(models.Model):
    ...
    min_deposit = models.DecimalField('Мин ввод', default=1, decimal_places=DECIMAL_PLACES, max_digits=MAX_DIGITS, help_text='')
    min_withdraw = models.DecimalField('Мин вывод', default=100, decimal_places=DECIMAL_PLACES, max_digits=MAX_DIGITS, help_text='')
    max_trade = models.DecimalField('Макс торговый лот', default=100, decimal_places=DECIMAL_PLACES, max_digits=MAX_DIGITS, help_text='')
    min_trade = models.DecimalField('Мин торговый лот', default=1, decimal_places=DECIMAL_PLACES, max_digits=MAX_DIGITS, help_text='')
    min_trade_usdt = models.DecimalField('Мин торговый лот в usdt', default=5, decimal_places=DECIMAL_PLACES, max_digits=MAX_DIGITS, help_text='')
